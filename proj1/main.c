...
void voltage(void){
	if(milis() - volt_time = 1000){
			...
			volt=(volt100)+volt1;hodnota v setinách volt(100mv)
			y=(420-volt)104;dosazení do trojèlenky pro zisk procentuální hodnoty
			y=100-y;
			
			volt=(slot25)1024;hodnota jednotek volt
			volt1=(slot25)%102410;hodnota setin volt
			volt=(volt100)+volt1;hodnota v setinách volt(100mv)
			x=(420-volt)104;dosazení do trojèlenky pro zisk procentuální hodnoty
			x=100-y;
